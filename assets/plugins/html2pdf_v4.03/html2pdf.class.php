...
if (!defined('__CLASS_HTML2PDF__')) {
    ...
    class HTML2PDF
    {
        ...
        protected $_format           = 'A5';        // page format : A4, A3, ...
         ...
         */
        public function __construct($orientation = 'l', $format = 'A5', $langue='fr', $unicode=true, $encoding='UTF-8', $marges = array(5, 5, 5, 8))
        {
...
'.$content.'
        ...
        protected function _drawImage($src, $subLi=false)
        {
            ...
            // WARNING : iallof URL, "w_url_fopen" must turned to "on" in php.ini
