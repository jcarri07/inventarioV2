...
if ($parametro != null) {
    ...
    try {
        $stmt = $conn->prepare( "INSERT INTO transaccion_equipos (codigo_transaccion,tipo_transaccion,codigo,motivo,entrega,cedula_e,lugar_e,empresa,recibe,cedula_r,lugar_r,empresa_r,created_date,created_user) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
            ...
            $accion = "Importacion de Transaccion de Equipos";
