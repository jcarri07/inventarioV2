...
if ($_GET['form']=='add') { ?> 
  ...
  <section class="content-header">
    <h1>
      <i class="fa fa-edit icon-title"></i> Datos de Entradas / Salidas de Biblioteca
    </h1>
    <ol class="breadcrumb">
      <li><a href="?module=start"><i class="fa fa-home"></i> Inicio </a></li>
      <li><a href="?module=transaccion_equipos_biblioteca"> Biblioteca </a></li>
        ...
        <div class="box box-primary">
          ...
          <form role="form" class="form-horizontal" action="modules/transaccion_equipos_biblioteca/proses.php?act=insert" method="POST" name="formObatMasuk">
            <div class="box-body">
              ...
              $query_id = mysqli_query($mysqli, "SELECT RIGHT(codigo_transaccion,6) as codigo FROM transaccion_equipos_biblioteca
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control" name="lugar_e" id="sede_entrega" value="<?php echo $sede; ?>" autocomplete="off" required readonly>
                </div>
              </div>  
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label">Sede</label>
                <div class="col-sm-5">
                  <input type="text" class="form-control" id="sede_recibe" name="lugar_r" 
