...
<section class="content-header">
  ...
  <h2>
  <i class="fa fa-folder-o icon-title"></i> 18000-0000 | Equipos científicos, religiosos, de enseñanza y recreación 
    ...
    <form action="database/excel_to_mysql_cientificos.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="btn-group pull-right" role="group" aria-label="Basic example"> 
          ...
          <a class="btn btn-primary btn-social  pull-right botones" href="database\php_excel_cientificos.php" data-toggle="tooltip">
            <i class="fa fa-sign-out"></i></i>Exportar&nbsp;&nbsp;
          </a>

          <a class="btn btn-primary btn-social  pull-right botones" href="?module=form_cientificos&form=add" data-toggle="tooltip">
          ...
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            while ($data = mysqli_fetch_assoc($query)) { 
              ...
              echo "<tr>
                    ...
                    <a data-toggle='tooltip' data-placement='top' title='Modificar' style='margin-right:0.3px' class='btn btn-primary btn-xs' href='?module=form_cientificos&form=edit&id=$data[codigo]'>
                        <i style='color:#fff' class='glyphicon glyphicon-edit'></i>
                    </a>";
            ?>
                    <a data-toggle="tooltip" data-placement="top" title="Eliminar" class="btn btn-danger btn-xs" href="modules/cientificos/proses.php?act=delete&id=<?php echo $data['codigo'];?>" onclick="return confirm('¿Seguro de eliminar <?php echo $data['descripcion'].' '.$data['serial']; ?>?');">
                        <i style="color:#fff" class="glyphicon glyphicon-trash"></i>
                    </a>         
            <?php

              if ($data['estado']=='nochequeado') { ?>
                  <a data-toggle="tooltip" data-placement="top" title="No chequeado"  class="btn btn-default btn-xs" href="modules/cientificos/proses.php?act=off&codigo=<?php echo $data['codigo'];?>">
                  <i style="color:#F3EFEF" class="glyphicon glyphicon-unchecked"></i>
              </a> 
             <?php
             } 
             else { ?>
                   <a data-toggle="tooltip" data-placement="top" title="Chequeado"  class="btn btn-success btn-xs" href="modules/cientificos/proses.php?act=on&codigo=<?php echo $data['codigo'];?>">
            ...
            <script>
              ...
              btn.addEventListener("click", ()=> {
                if(confirm("¿Deseas eliminar el chequeo de todos los equipos?")) {
                    window.location.href = "modules/cientificos/proses.php?act=reset";
                  } 
              })
            </script>
            </tbody>
