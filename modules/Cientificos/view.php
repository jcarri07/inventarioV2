  ...
  <i class="fa fa-folder-o icon-title"></i> 18000-0000 | Equipos Científicos, Religiosos, de Enseñanza y Recreación 
    ...
    <form action="database/excel_to_mysql_cientificos.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="btn-group pull-right" role="group" aria-label="Basic example"> 
          ...
          <a class="btn btn-primary btn-social  pull-right botones" href="?module=form_Cientificos&form=add"  title="Agregar" data-toggle="tooltip">
           ...
           <a class="btn btn-primary pull-right botones" id="btnElect" style="height:35px;">
            ...
            <script>
              ...
              btn.addEventListener("click", ()=> {
                if(confirm("Deseas eliminar el chequeo de todos los equipos científicos y Cientificos?")) {
