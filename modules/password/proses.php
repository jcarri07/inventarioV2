...
if (empty($_SESSION['username']) && empty($_SESSION['password'])){
    ...
    if (isset($_POST['Guardar'])) {
        if (isset($_SESSION['id_user'])) {
            ...
            $old_pass    = mysqli_real_escape_string($mysqli, trim($_POST['old_pass']));
            $new_pass    = mysqli_real_escape_string($mysqli, trim($_POST['new_pass']));
            $retype_pass = mysqli_real_escape_string($mysqli, trim($_POST['retype_pass']));
