...
if ($_GET['form']=='add') { ?> 
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="?module=transaccion_equipos"> Equipos </a></li>
        ...
        <div class="box box-primary">
          ...
          <form role="form" class="form-horizontal" action="modules/transaccion_equipos/proses.php?act=insert" method="POST" name="formObatMasuk">
            <div class="box-body">
              ...
              $query_id = mysqli_query($mysqli, "SELECT RIGHT(codigo_transaccion,6) as codigo FROM transaccion_equipos
              ...
              <div class="form-group">  
                ...
                <div class="col-sm-5">
                  <select class="chosen-select" name="codigo" data-placeholder="-- Seleccionar equipo --" onchange="tampil_obat(this)" autocomplete="off" required>
                    <option value=""></option>
                    <?php
                      $query_obat = mysqli_query($mysqli, "SELECT codigo, descripcion FROM inventario ORDER BY nombre ASC")
                                                            or die('error '.mysqli_error($mysqli));
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control" id="empresa_entrega" name="empresa" value="ABAE" autocomplete="off" required readonly>
                </div>
              </div>    
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label">Empresa</label>
                <div class="col-sm-5">
                  <input type="text" class="form-control" id="empresa_recibe" name="empresa_r" autocomplete="off" required>
                </div>
              </div>  
