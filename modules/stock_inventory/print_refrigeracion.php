...
$query = mysqli_query($mysqli, "SELECT * FROM inventario WHERE categoria LIKE 'Electrodomesticos' ORDER BY codigo ASC")
    or die('Error ' . mysqli_error($mysqli));
...
<?php
$filename = "REPORTE DE INVENTARIO ELECTRODOMESTICOS.pdf";
//==========================================================================================================
