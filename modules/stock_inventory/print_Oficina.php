...
if ($access === 'Super Admin') {
    $query = mysqli_query($mysqli, "SELECT * FROM inventario WHERE categoria LIKE 'Oficina' AND sede LIKE '$sede' ORDER BY codigo DESC") or die('Error ' . mysqli_error($mysqli));
    $count  = mysqli_num_rows($query);
} else {
    $query = mysqli_query($mysqli, "SELECT * FROM inventario WHERE categoria LIKE 'Oficina' ORDER BY codigo DESC") or die('Error ' . mysqli_error($mysqli));
    $count  = mysqli_num_rows($query);
}
...
<body>
    ...
    <div id="title">
        REPORTE DE INVENTARIOS (Oficina)
    </div>
...
<?php
$filename = "Reporte Inventarios Oficina.pdf";
//==========================================================================================================
