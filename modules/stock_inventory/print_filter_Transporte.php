...
if ($var != "" && $var2 == "" && $var3 == "" && $access !== 'Super Admin') {
    ...
    $query = mysqli_query($mysqli, "SELECT * FROM Transporte WHERE $filtro LIKE '$var%' AND sede LIKE '$sede' ORDER BY codigo DESC")
        or die('Error ' . mysqli_error($mysqli));
...
if ($var != "" && $var2 != "" && $var3 == "" && $access !== 'Super Admin') {
    ...
    $query = mysqli_query($mysqli, "SELECT * FROM Transporte WHERE $filtro LIKE '$var%' && $filtro2 LIKE '$var2%' AND sede LIKE '$sede' ORDER BY codigo DESC")
        or die('Error ' . mysqli_error($mysqli));
    $count  = mysqli_num_rows($query);
} else if ($var != "" && $var2 != "" && $var3 == "") {
...
if ($var != "" && $var2 != "" && $var3 != "" && $access !== 'Super Admin') {
    ...
    $query = mysqli_query($mysqli, "SELECT * FROM Transporte WHERE $filtro LIKE '$var%' && $filtro2 LIKE '$var2%' && $filtro3 LIKE '$var3%' AND sede LIKE '$sede' ORDER BY codigo DESC")
        or die('Error ' . mysqli_error($mysqli));
    $count  = mysqli_num_rows($query);
} else if ($var != "" && $var2 != "" && $var3 != "") {
            ...
            <tbody>
                ...
                while ($data = mysqli_fetch_assoc($query)) {
                    ...
                    echo "  <tr>
                        ...
                        <td width='100' height='16' align='center' valign='middle'>$data[placa]</td>
                        <td width='100' height='16' align='center' valign='middle'>$data[anio]</td>
