...
$query = mysqli_query($mysqli, "SELECT * FROM inventario WHERE categoria LIKE 'Comunicacion' ORDER BY codigo DESC")
    or die('Error ' . mysqli_error($mysqli));
...
<head>
    ...
    <title>REPORTE DE INVENTARIOS (COMUNICACION)</title>
...
<body>
    ...
    <div id="title">
        REPORTE DE INVENTARIOS (COMUNICACION)
    </div>
...
<?php
$filename = "REPORTE DE INVENTARIOS COMUNICACION.pdf";
//==========================================================================================================
