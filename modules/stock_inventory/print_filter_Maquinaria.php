...
if ($var != "" && $var2 == "" && $var3 == "" && $access !== 'Super Admin') {
    ...
    $query = mysqli_query($mysqli, "SELECT * FROM inventario WHERE $filtro LIKE '$var%' AND sede LIKE '$sede' AND categoria LIKE 'Maquinaria' ORDER BY codigo DESC")
        or die('Error ' . mysqli_error($mysqli));
...
if ($var != "" && $var2 != "" && $var3 == "" && $access !== 'Super Admin') {
    ...
    $query = mysqli_query($mysqli, "SELECT * FROM inventario WHERE $filtro LIKE '$var%' && $filtro2 LIKE '$var2%' AND sede LIKE '$sede' AND categoria LIKE 'Maquinaria' ORDER BY codigo DESC")
        or die('Error ' . mysqli_error($mysqli));
    $count  = mysqli_num_rows($query);
} else if ($var != "" && $var2 != "" && $var3 == "") {
...
if ($var != "" && $var2 != "" && $var3 != "" && $access !== 'Super Admin') {
    ...
    $query = mysqli_query($mysqli, "SELECT * FROM inventario WHERE $filtro LIKE '$var%' && $filtro2 LIKE '$var2%' && $filtro3 LIKE '$var3%' AND sede LIKE '$sede' AND categoria LIKE 'Maquinaria' ORDER BY codigo DESC")
        or die('Error ' . mysqli_error($mysqli));
    $count  = mysqli_num_rows($query);
} else if ($var != "" && $var2 != "" && $var3 != "") {
...
<?php
$filename = "Reporte Inventarios Maquinaria Filtrado.pdf";
//==========================================================================================================
