...
if ($_GET['form']=='add') { ?> 
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="?module=transaccion_equipos_vehiculos"> Vehículos </a></li>
        ...
        <div class="box box-primary">
          ...
          <form role="form" class="form-horizontal" action="modules/transaccion_equipos_vehiculos/proses.php?act=insert" method="POST" name="formObatMasuk">
            <div class="box-body">
              ...
              $query_id = mysqli_query($mysqli, "SELECT RIGHT(codigo_transaccion,6) as codigo FROM transaccion_equipos_vehiculos
              ...
              <div class="form-group">  
                ...
                <div class="col-sm-5">
                  <select class="chosen-select" name="codigo" data-placeholder="-- Seleccionar vehículo --" onchange="tampil_obat(this)" autocomplete="off" required>
                    <option value=""></option>
                    <?php
                      $query_obat = mysqli_query($mysqli, "SELECT codigo, marca FROM vehiculos ORDER BY marca ASC")
                                                            or die('error '.mysqli_error($mysqli));
