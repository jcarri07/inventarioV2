...
if (empty($_SESSION['username']) && empty($_SESSION['password'])){
    ...
    if ($_GET['act'] == 'insert') {
        if (isset($_POST['Guardar'])) {
            ...
            $query = mysqli_query($mysqli, "INSERT INTO transaccion_equipos_vehiculos(codigo_transaccion,created_date,codigo,motivo,recibe,cedula_r,empresa_r,entrega,cedula_e,empresa,lugar_r,lugar_e,created_user,tipo_transaccion) 
            ...
            if ($query) {
                ...
                if ($query1) {                       
                    ...
                    header("location: ../../main.php?module=transaccion_equipos_vehiculos&alert=1");
                }
            }   
        }   
    }
