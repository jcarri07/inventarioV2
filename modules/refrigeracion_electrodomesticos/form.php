...
if ($_GET['form']=='add') { ?> 
  ...
  <section class="content-header">
    <h1>
      <i class="fa fa-edit icon-title"></i> Agregar equipos de refrigeracion/electrodomesticos
    </h1>
    <ol class="breadcrumb">
      <li><a href="?module=start"><i class="fa fa-home"></i> Inicio </a></li>
      <li><a href="?module=refrigeracion_electrodomesticos"> Agregar </a></li>
...
elseif ($_GET['form']=='edit') { 
  if (isset($_GET['id'])) {
      ...
      $query = mysqli_query($mysqli, "SELECT categoria,codigo,serial,marca,modelo,bienesN,color,descripcion,condicion,ubicacion,nombre,cedula,sede,pertenece,precio_compra,precio_venta,unidad FROM inventario WHERE codigo='$_GET[id]'") 
                                      or die('error: '.mysqli_error($mysqli));
      $data  = mysqli_fetch_assoc($query);
    }
?>
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      <li><a href="?module=start"><i class="fa fa-home"></i> Inicio </a></li>
      <li><a href="?module=refrigeracion_electrodomesticos">Item</a></li>
          ...
          <form role="form" class="form-horizontal" action="modules/refrigeracion_electrodomesticos/proses.php?act=update" method="POST">
            <div class="box-body">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label">Cedula</label>
                <div class="col-sm-5">
                  <input type="text" class="form-control" name="cedula" autocomplete="off" onkeypress='return validaNumericos(event)'  value="<?php echo $data['cedula']; ?>" required>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label">Sede</label>
             ...
             <!-- <div class="form-group">
              ...
              <div class="form-group" >
                <label class="col-sm-2 control-label">Pertenece</label>
                <div class="col-sm-5">
                <input class="form-control" list="item2" type="text" value="<?php echo $data['pertenece'];?>" name="pertenece" autocomplete="off" required>
                  <datalist id="item2">
