...
$accion = "Registro de equipo (Electrodomesticos)";
...
if (empty($_SESSION['username']) && empty($_SESSION['password'])){
    ...
    if ($_GET['act']=='insert') {
        if (isset($_POST['Guardar'])) {
            ...
            if (buscaRepetido($serial,$mysqli) == 1) {
                 header("location: ../../main.php?module=refrigeracion_electrodomesticos&alert=5");
                ...
                $query = mysqli_query($mysqli, "INSERT INTO history(nombre, accion, cedula, permiso, fecha, hora) 
                                            ...
                                            or die('error '.mysqli_error($mysqli));
                header("location: ../../main.php?module=refrigeracion_electrodomesticos&alert=1");  
            }
        }   
    }
            ...
            if (isset($_POST['codigo'])) {
               ...
               // $pcompra = str_replace('.', '', mysqli_real_escape_string($mysqli, trim($_POST['pcompra'])));
                ...
                $query = mysqli_query($mysqli, "UPDATE inventario SET 
                 ...
                 $accion = "Modificacion de equipo (Electrodomesticos)";

                 $query = mysqli_query($mysqli, "INSERT INTO history(nombre, accion, cedula, permiso, fecha, hora) 
                                            VALUES('$NombreUser','$accion','$cedulauser', '$iduser', NOW(), DATE_FORMAT(NOW( ), '%H:%I:%S' ))")
                                            or die('error '.mysqli_error($mysqli)); 

                header("location: ../../main.php?module=refrigeracion_electrodomesticos&alert=2");
                }        
            }
        }
    }
    ...
    if ($_GET['act']=='delete') {
        ...
        if (isset($_GET['id'])) {
            ...
            $accion = "Eliminacion de equipo (Electrodomesticos)";
            ...
            if ($query) {
                ...
                header("location: ../../main.php?module=refrigeracion_electrodomesticos&alert=3");
            }
        }
    }  
    ...
    if ($_GET['act']=='on' && $_SESSION['permisos_acceso'] == "Super Admin") {
		if (isset($_GET['codigo'])) {
            ...
            if ($query) {
                ...
                header("location: ../../main.php?module=refrigeracion_electrodomesticos");
            }
		}
	} 
