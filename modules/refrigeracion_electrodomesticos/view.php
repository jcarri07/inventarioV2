...
<section class="content-header">
  ...
  <h2>
  <i class="fa fa-folder-o icon-title"></i> Equipos de refrigeracion y electrodomesticos
    ...
    <form action="database/excel_to_mysql_refrigeracion.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="btn-group pull-right" role="group" aria-label="Basic example"> 
          ...
          <a class="btn btn-primary btn-social  pull-right botones" href="database\php_excel_refrigeracion.php" title="Exportar" data-toggle="tooltip">
      ...
      <div class="box box-primary">
        <div class="box-body">
          ...
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            $query = mysqli_query($mysqli, "SELECT codigo,descripcion,serial,marca,modelo,color,bienesN, condicion, ubicacion, nombre, cedula, sede, pertenece,cantidad,precio_compra,precio_venta,unidad,estado FROM inventario WHERE categoria= 'Refrigeracion' and sede LIKE '$sede' ORDER BY codigo ASC")
                                            or die('error: '.mysqli_error($mysqli));
           ...
           <a class="btn btn-primary pull-right" href="modules/refrigeracion_electrodomesticos/proses.php?act=reset"  style="height:35px;">
            <i></i> Reset Check
           </a>
