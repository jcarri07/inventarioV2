...
$var = $_POST['nombre_inmuebles'];
$filtro = $_POST['filtrar_inmuebles']; trim($filtro);
...
$query = mysqli_query($mysqli, "SELECT a.tipo_transaccion, a.codigo_transaccion, a.codigo, a.motivo, a.entrega, a.cedula_e, lugar_e, a.recibe, a.cedula_r, a.lugar_r, a.created_date, b.codigo,b.descripcion
