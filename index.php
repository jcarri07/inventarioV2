  ...
  <body class="login-page bg-login">
    <div class="login-box">
      <div style="color:#3c8dbc" class="login-logo">
        <img style="margin-top:-12px" src="./assets/img/ABAE_Logo.png" alt="Logo" height="60"><b>ABAES</b>
      </div><!-- /.login-logo -->
      <?php  
      ...
      elseif ($_GET['alert'] == 1) {
        echo "<div class='alert alert-danger alert-dismissable'>
                ...
                Usuario o contraseña incorrecta, verifique su nombre de usuario y contraseña
              </div>";
      }
